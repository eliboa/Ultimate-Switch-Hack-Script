...
echo.
echo 4: Verify if a Switch serial is patched or not?
echo.
echo 5: Verify a keys file?
echo.
echo 6: Use the Hid-mitm Compagnon software?
echo.
echo 7: Launch the emuGUIibo software?
echo.
