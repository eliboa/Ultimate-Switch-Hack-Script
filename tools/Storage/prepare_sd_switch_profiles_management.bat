...
echo set "emunand_enable=%emunand_enable%">>"%profile_path%"
echo set "emummc_id=%emummc_id%">>"%profile_path%"
echo set "emummc_sector=%emummc_sector%">>"%profile_path%"
echo set "emummc_path=%emummc_path%">>"%profile_path%"
echo set "emummc_nintendo_path=%emummc_nintendo_path%">>"%profile_path%"
